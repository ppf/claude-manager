...
export function GitAuthHelpDialog({ open, onOpenChange }: GitAuthHelpDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <Alert>
            <AlertDescription>
              Private repositories require authentication. Choose one of the methods below:
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  Add to SSH agent:{' '}
                  <code className="bg-muted px-1 py-0.5 rounded">ssh-add ~/.ssh/id_ed25519</code>
                </li>
                <li>
                  Copy public key:{' '}
                  <code className="bg-muted px-1 py-0.5 rounded">cat ~/.ssh/id_ed25519.pub</code>
                </li>
                <li>Add to GitHub: Settings → SSH and GPG keys → New SSH key</li>
                <li>
                  Use SSH URLs:{' '}
                  <code className="bg-muted px-1 py-0.5 rounded">git@github.com:user/repo.git</code>
                </li>
              </ol>
            </div>
            ...
            <div className="pt-4 border-t">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                <li>
                  ...
                  <code className="bg-muted px-1 py-0.5 rounded">ssh -T git@github.com</code>
                </li>
                <li>
                  Check git config:{' '}
                  <code className="bg-muted px-1 py-0.5 rounded">git config --list</code>
                </li>
                <li>
                  Clear credentials:{' '}
                  <code className="bg-muted px-1 py-0.5 rounded">
